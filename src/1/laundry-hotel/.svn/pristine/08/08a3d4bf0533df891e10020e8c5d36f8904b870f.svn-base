...
{
    public class QRCodeCheckOutModel : ViewModelBase
    {
        /// <summary>
        ...
        private string _bindingStateColor;
        public string BindingStateColor
        {
            get { return _bindingStateColor; }
            set
            {
                _bindingStateColor = value;
                this.RaisePropertyChanged("BindingStateColor");
            }
        }
